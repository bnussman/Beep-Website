                ...
                <div className="rounded overflow-hidden shadow-md mb-4">
                    <div className="px-6 py-4">
                        ...
                        <p className="text-gray-700 text-base">
                            <p className="mb-4">Last updated August 13, 2020</p>

                            <p className="mb-4">Thank you for choosing to be part of our community at Ride Beep (&ldquo;Company&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;, or &ldquo;our&rdquo;). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about this privacy notice, or our practices with regards to your personal information, please contact us at banks@ridebeep.app.<br />
                                When you visit our website ridebeep.app (the &quot;Website&quot;), use our mobile application, as the case may be (the &quot;App&quot;) and more generally, use any of our services (the &quot;Services&quot;, which include the Website and App), we appreciate that you are trusting us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Services immediately.<br />
                                This privacy notice applies to all information collected through our Services (which, as described above, includes our Website and App), as well as any related services, sales, marketing or events.<br />
                            ...
                            <p className="mb-4">TABLE OF CONTENTS<br />
                                ...
                                12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?</p>

                            <p className="mb-4">1. WHAT INFORMATION DO WE COLLECT?</p>

                            <p className="mb-4">Personal information you disclose to us<br />
                                In Short: We collect information that you provide to us.<br />
                                We collect personal information that you voluntarily provide to us when you register on the Services, express an interest in obtaining information about us or our products and Services, when you participate in activities on the Services (such as by posting messages in our online forums or entering competitions, contests or giveaways) or otherwise when you contact us.<br />
                                The personal information that we collect depends on the context of your interactions with us and the Services, the choices you make and the products and features you use. The personal information we collect may include the following:<br />
                                Personal Information Provided by You. We collect names; phone numbers; email addresses; usernames; passwords; venmo username; and other similar information.<br />
                            ...
                            <p className="mb-4">Information automatically collected<br />
                                In Short: Some information &mdash; such as your Internet Protocol (IP) address and/or browser and device characteristics &mdash; is collected automatically when you visit our Services.</p>
                            ...
                            <p className="mb-4">The information we collect includes:<br />
                            ...
                            <p className="mb-4">Information collected through our App<br />
                                In Short: We collect information regarding your geo-location, push notifications, when you use our App.<br />
                                ...
                                The information is primarily needed to maintain the security and operation of our App, for troubleshooting and for our internal analytics and reporting purposes.</p>
                            ...
                            <p className="mb-4">
                                ...
                                To facilitate account creation and logon process. If you choose to link your account with us to a third-party account (such as your Google or Facebook account), we use the information you allowed us to collect from those third parties to facilitate account creation and logon process for the performance of the contract.</p>

                            <p className="mb-4">
                                To post testimonials. We post testimonials on our Services that may contain personal information. Prior to posting a testimonial, we will obtain your consent to use your name and the consent of the testimonial. If you wish to update, or delete your testimonial, please contact us at banks@ridebeep.app and be sure to include your name, testimonial location, and contact information.</p>

                            <p className="mb-4">
                                Request feedback. We may use your information to request feedback and to contact you about your use of our Services.</p>

                            <p className="mb-4">
                                To enable user-to-user communications. We may use your information in order to enable user-to-user communications with each user's consent.</p>

                            <p className="mb-4">
                                To manage user accounts. We may use your information for the purposes of managing our account and keeping it in working order.</p>

                            <p className="mb-4">To send administrative information to you. We may use your personal information to send you product, service and new feature information and/or information about changes to our terms, conditions, and policies.</p>

                            <p className="mb-4">
                                To protect our Services. We may use your information as part of our efforts to keep our Services safe and secure (for example, for fraud monitoring and prevention).</p>

                            <p className="mb-4">
                                To enforce our terms, conditions and policies for business purposes, to comply with legal and regulatory requirements or in connection with our contract.</p>

                            <p className="mb-4">
                                To respond to legal requests and prevent harm. If we receive a subpoena or other legal request, we may need to inspect the data we hold to determine how to respond.</p>

                            <p className="mb-4">Fulfill and manage your orders. We may use your information to fulfill and manage your orders, payments, returns, and exchanges made through the Services.</p>

                            <p className="mb-4">
                                Administer prize draws and competitions. We may use your information to administer prize draws and competitions when you elect to participate in our competitions.</p>

                            <p className="mb-4">
                                To deliver and facilitate delivery of services to the user. We may use your information to provide you with the requested service.</p>

                            <p className="mb-4">
                                To respond to user inquiries/offer support to users. We may use your information to respond to your inquiries and solve any potential issues you might have with the use of our Services.</p>
                            ...
                            <p className="mb-4">3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?<br />
                            ...
                            <p className="mb-4">4. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?<br />
                            ...
                            <p className="mb-4">5. DO WE USE GOOGLE MAPS?<br />
                                In Short: Yes, we use Google Maps for the purpose of providing better service.<br />
                                This Website or App uses Google Maps APIs which is subject to Google's Terms of Service. You may find the Google Maps APIs Terms of Service here. To find out more about Google&rsquo;s Privacy Policy, please refer to this link.<br />
                                We use the Google Maps API to retrieve certain information when you make location-specific requests. This includes:<br />
                                &#9632; Current Location Upon users request<br />
                                &#9632; Current Location while being beeped<br />
                                For a full list of what we use information for, please see the previous section titled &quot;HOW DO WE USE YOUR INFORMATION?&quot; and &ldquo;WILL YOUR INFORMATION BE SHARED WITH ANYONE?&rdquo;. We obtain and store on your device ('cache') your location. You may revoke your consent anytime by contacting us at the contact details provided at the end of this document.<br />
                                The Maps APIs that we use store and access cookies and other information on your devices. If you are a user currently in the European Economic Area (EU countries, Iceland, Liechtenstein and Norway), please take a look at our Cookie Notice.</p>

                            <p className="mb-4">6. HOW LONG DO WE KEEP YOUR INFORMATION?<br />
                            ...
                            <p className="mb-4">7. HOW DO WE KEEP YOUR INFORMATION SAFE?<br />
                            ...
                            <p className="mb-4">8. WHAT ARE YOUR PRIVACY RIGHTS?<br />
                                ...
                                If you are resident in Switzerland, the contact details for the data protection authorities are available here: https://www.edoeb.admin.ch/edoeb/en/home.html.</p>

                            <p className="mb-4">If you have questions or comments about your privacy rights, you may email us at banks@ridebeep.app.</p>

                            <p className="mb-4">Account Information<br />
                                ...
                                Opting out of email marketing: You can unsubscribe from our marketing email list at any time by clicking on the unsubscribe link in the emails that we send or by contacting us using the details provided below. You will then be removed from the marketing email list &ndash; however, we may still communicate with you, for example to send you service-related emails that are necessary for the administration and use of your account, to respond to service requests, or for other non-marketing purposes. To otherwise opt-out, you may:<br />
                                &#9632; Access your account settings and update your preferences.</p>

                            <p className="mb-4">9. CONTROLS FOR DO-NOT-TRACK FEATURES<br />
                            ...
                            <p className="mb-4">10. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?<br />
                            ...
                            <p className="mb-4">11. DO WE MAKE UPDATES TO THIS NOTICE?<br />
                            ...
                            <p className="mb-4">12. HOW CAN YOU CONTACT US ABOUT THIS NOTICE?<br />
                                If you have questions or comments about this notice, you may email us at banks@ridebeep.app or by post to:<br />
                                Ride Beep <br />
                                397 Perkinsville Dr Unit 304(A)<br />
                                Boone, NC 28607<br />
                                United States</p>

                            <p className="mb-4">HOW CAN YOU REVIEW, UPDATE, OR DELETE THE DATA WE COLLECT FROM YOU?<br />
                                Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it in some circumstances. To request to review, update, or delete your personal information, please visit: https://ridebeep.app/profile. We will respond to your request within 30 days.</p>
                        </p>
                    </div>
                </div>
            </div>
