...
export function Heading1(props) {
    return (
        <h1 className="py-4 text-5xl font-bold leading-7 text-gray-800 ">{props.children}</h1>
    )
}

export function Heading2(props) {
    return (
        <h2 className="py-3 text-4xl font-bold leading-7 text-gray-800">{props.children}</h2>
    )
}
...
export function Heading4(props) {
    return (
        <h4 className="py-1 text-2xl font-bold leading-7 text-gray-800">{props.children}</h4>
    )
}
